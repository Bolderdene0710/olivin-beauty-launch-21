...
--
-- Name: orders Anyone can view orders by order number; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Anyone can view orders by order number" ON public.orders FOR SELECT TO authenticated, anon USING (true);
